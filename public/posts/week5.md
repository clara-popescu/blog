...
* I found a huge dataset full of words people use to describe themselves. It would be nice to find a way to bring it into the project, but I will focus on the most basic aspects of it for now.
    ...
    * [all responses](https://jasonjones.ninja/ipseology-central/blog/human-identity-100k.html)
* I started thinking about my methodology and what I could include in that section. I felt a bit unsure about what exactly needed to go there, but I re-read the lecture slides and some examples, and I started drafting a rough outline for it.